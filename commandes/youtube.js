...
_*zim cyber md* is downloading the file_\n\n`
       }
...
zokou({
  ...
  try {
    ...
    if (videos && videos.length > 0 && videos[0]) {
      ...
      let InfoMess = {
        image: { url: videos[0].thumbnail },
        caption: `*zim cyber md* song downloader📂\n\nVideo name : _${Element.title}_
Time : _${Element.timestamp}_
Url : _${Element.url}_
_\n*zim cyber md* is downloading the file_\n\n`
      };
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "┃generated by shellah bot┃", gifPlayback: false }, { quoted: ms });
      });
